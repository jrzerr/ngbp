module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    /**
     * `grunt-replace` handles our applications setup within different
     * environments like production, staging, testing, development.
     * Create and environment-specific config file in:
     * src/config/environments/xxx.json
     */
    replace: {
      development: {
        options: {
        ...
        files: [
          {
            src: [ '<%= build_dir %>/src/config/config.js' ],
            dest: '<%= build_dir %>/src/config/',
            expand: true,
            flatten: true
          }
        ]
    ...
    */
    ...
    delta: {
      ...
      jssrc: {
        ...
        tasks: [ 'jshint:src', 'karma:unit:run', 'copy:build_appjs', 'replace:development' ]
      },
  ...
  grunt.registerTask( 'watch', [ 'build', 'replace:development', 'karma:unit', 'delta' ] );

  /**
   * The default task is to build and compile.
   */
  grunt.registerTask( 'default', [ 'build', 'replace:production', 'compile' ] );
